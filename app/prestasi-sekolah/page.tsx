          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-8 bg-(--color-forest-450) dark:bg-(--color-forest-900) rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden flex flex-col justify-center min-h-[400px] shadow-xl">
              ...
              <div className="relative z-10">
                <Badge className="bg-white text-(--color-forest-450) hover:bg-white border-0 px-4 py-1.5 mb-8 text-xs sm:text-sm font-black uppercase tracking-widest shadow-md inline-flex items-center gap-2">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tight drop-shadow-sm uppercase">
                  Prestasi <br /> <span className="text-(--color-sun-200)">Institusi</span>
                </h1>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <div className="grid md:grid-cols-2 gap-8 items-end">
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-widest text-(--color-forest-450) mb-2 block">Filter Berdasarkan Tahun</label>
            ...
            {!isSearching && paginationMeta && (
              <div className="flex items-center gap-3 px-6 py-2 bg-(--color-forest-450)/5 rounded-full border border-(--color-forest-450)/10 w-fit">
        ...
        <div className="grid gap-0 md:grid-cols-5">
          <div className="relative md:col-span-2 h-72 sm:h-80 md:h-auto overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 flex items-center gap-4">
              <div className="w-14 h-14 bg-(--color-forest-450) rounded-2xl flex items-center justify-center shadow-xl">
          ...
          <div className="p-10 md:col-span-3 flex flex-col">
            <div className="flex items-center gap-6 mb-6">
              <div className="flex flex-wrap gap-2">
                {achievement.kategori && achievement.kategori.length > 0 && achievement.kategori.map((kat) => (
                  <Badge key={kat.slug} className="bg-(--color-forest-450)/10 text-(--color-forest-450) border-(--color-forest-450)/10 font-black uppercase tracking-widest text-[9px] px-3 py-1.5 dark:bg-(--color-forest-450)/30">
                    {kat.name}
                  </Badge>
                ))}
              </div>
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">               <Calendar className="w-3.5 h-3.5 text-(--color-forest-450)" />
                <span>{formatDate(achievement.tanggal)}</span>
              </div>
            </div>
            <h2 className="mb-4 text-3xl font-black text-gray-900 dark:text-white transition-colors group-hover:text-(--color-forest-450) uppercase tracking-tight leading-tight">
              {achievement.name}
            </h2>
            ...
            <div className="mt-auto flex items-center justify-between pt-6 border-t border-gray-100 dark:border-white/5">
              ...
              <Button variant="ghost" className="text-[10px] font-black uppercase tracking-widest text-(--color-forest-450) hover:bg-(--color-forest-450)/10 dark:hover:bg-(--color-forest-450)/20 rounded-xl px-6">
                LIHAT SELENGKAPNYA
              </Button>
            </div>
          </div>
