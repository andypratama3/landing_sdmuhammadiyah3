<!-- frontend-standard-skills:nextjs START — do not edit between these markers, regenerate with `npx frontend-standard-skills add nextjs` -->
...
<!-- frontend-standard-skills:nextjs END -->
