        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-colors">
              <div className="w-20 h-20 bg-(--color-forest-700) hover:bg-(--color-forest-500) text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all border-[6px] border-white/20">
